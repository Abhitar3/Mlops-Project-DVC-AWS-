...
def main():
    try:
        ...
        max_features = params.get('feature_engineering', {}).get('max_features', 50)
        if 'feature_engineering' not in params:
            logger.warning('feature_engineering section missing in params.yaml; using default max_features=50')
